...
- ESP32 is Primary   
When using Arduino environment as a Secondary, use Ra01S-Pong in ArduinoCode.   
```
+-----------+           +-----------+            +-----------+           +-----------+
|           |           |           |            |           |           |           |
...
- ESP32 is Secondary   
When using Arduino environment as a Primary, use Ra01S-Ping in ArduinoCode.   
...
### Build as a primary   
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/dc53207c-4427-4ba3-87e5-1876a20bc4de" />
